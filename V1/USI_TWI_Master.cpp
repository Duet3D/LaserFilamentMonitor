...
static bool USI_TWI_Start_Transceiver_With_Data(uint8_t * array, uint8_t);
static uint8_t USI_TWI_Master_Transfer(uint8_t);
static bool USI_TWI_Master_Start();
...
/*---------------------------------------------------------------
 ...
 USI_TWI_Master.h
---------------------------------------------------------------*/
static bool USI_TWI_Start_Transceiver_With_Data(uint8_t * array msg, uint8_t msgSize)
{
